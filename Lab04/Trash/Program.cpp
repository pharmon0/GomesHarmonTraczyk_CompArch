...
{   
    OP_addi    |  vRd(XT1)| vRs1(XZR)| vImmI(0x400),
    OP_addi    |  vRd(XT0)| vRs1(XT1)| vImmI(0x400),
    OP_beq     | vRs1(XT0)| vRs2(XT1)| vImmB(28),
    OP_flw     |   vRd(F1)| vRs1(XT1)| vImmI(0),
    OP_flw     |   vRd(F2)| vRs1(XT1)| vImmI(0x400),
    OP_fadd    |   vRd(F3)|  vRs1(F1)| vRs2(F2),
    OP_fsw     | vRs1(XT1)|  vRs2(F3)| vImmI(0x800),
    OP_addi    |  vRd(XT1)| vRs1(XT1)| vImmI(4),
    OP_jal     |  vRd(XZR)| vImmJ(-24),
    OP_HALT
    ////R-type
...
int main(void){
    ...
    for(int i = 0; i < InstructionMemory.size(); i++){
        file << InstructionMemory.at(i) << endl;
    }
